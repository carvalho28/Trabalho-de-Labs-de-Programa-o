...
\hypertarget{SUB1_autotoc_md4}{}\doxysubsubsection{Objectives of the Project}\label{SUB1_autotoc_md4}
The objective of this project is to implement a program that asks the user 18 whole numbers and keep them in a vector, to later provide shape to calculate some statistics or perform operations on those values. The requested values must be between six and 28.
...
\hypertarget{SUB2_autotoc_md5}{}\doxysubsubsection{Main Features of the Project}\label{SUB2_autotoc_md5}
...
4 -\/ Construction of an 18x2 matrix, in which each line is composed of the vector read (first line) and four times the respective values (second line);

5 -\/ Calculation of the logarithm (natural basis) of all elements in the vector;

6 -\/ Return of values in multiple positions of three of the vector.\hypertarget{SUB2_autotoc_md6}{}\doxysubsubsection{Aditional Features of the Project}\label{SUB2_autotoc_md6}
...
5 -\/ The program additionally presents a help page, accessible as with entry seven on the menu;
